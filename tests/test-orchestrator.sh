...
run_tests() {
    ...
    run_cmd 2 "Installing base container with pacstrap" "pacstrap -c $SCRIPT_DIR/container/rootfs base systemd bash sudo btrfs-progs snapper snap-pac util-linux lsof parallel"
